/*
    EFT address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: EftChg (admin@eftchg.com).
*/
...
function EftAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('EFT-') == 0) adr = adr.substr(4);
