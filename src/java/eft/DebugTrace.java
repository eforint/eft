...
public final class DebugTrace {
    ...
    static final String QUOTE = Eft.getStringProperty("eft.debugTraceQuote", "");
    static final String SEPARATOR = Eft.getStringProperty("eft.debugTraceSeparator", "\t");
    static final boolean LOG_UNCONFIRMED = Eft.getBooleanProperty("eft.debugLogUnconfirmed");

    static void init() {
        List<String> accountIds = Eft.getStringListProperty("eft.debugTraceAccounts");
        String logName = Eft.getStringProperty("eft.debugTraceLog");
    ...
    private Map<String,String> lessorGuaranteedBalance(Long accountId, Long lesseeId) {
        ...
        map.put("timestamp", String.valueOf(Eft.getBlockchain().getLastBlock().getTimestamp()));
        map.put("height", String.valueOf(Eft.getBlockchain().getLastBlock().getHeight()));
    ...
    private Map<String,String> getValues(Long accountId, Block block, boolean isUndo) {
        ...
        map.put("effective balance", String.valueOf(Account.getAccount(accountId).getEffectiveBalanceEFT()));
