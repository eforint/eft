...
import static eft.http.JSONResponses.ERROR_INCORRECT_REQUEST;
import static eft.http.JSONResponses.ERROR_NOT_ALLOWED;
import static eft.http.JSONResponses.POST_REQUIRED;
...
public final class APIServlet extends HttpServlet {
    ...
    abstract static class APIRequestHandler {
        ...
        abstract JSONStreamAware processRequest(HttpServletRequest request) throws EftException;
    ...
    private static final boolean enforcePost = Eft.getBooleanProperty("eft.apiServerEnforcePOST");
