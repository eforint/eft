...
public class APITestServlet extends HttpServlet {
    ...
    private static final String header =
            ...
            "               <li><a href=\"https://wiki.eftcrypto.org/wiki/Eft_API\" target=\"_blank\">wiki docs</a></li>" +
            "           </ul>" +
            "       </div>" +
            "   </div>" + 
            "</div>" +
    ...
    private static String form(String requestType, String className, List<String> parameters) {
        ...
        buf.append("<form action=\"/eft\" method=\"POST\" onsubmit=\"return submitForm(this);\">");
