...
import static eft.http.JSONResponses.INCORRECT_MAXNUMBEROFOPTIONS;
import static eft.http.JSONResponses.INCORRECT_MINNUMBEROFOPTIONS;
import static eft.http.JSONResponses.INCORRECT_OPTIONSAREBINARY;
import static eft.http.JSONResponses.INCORRECT_POLL_DESCRIPTION_LENGTH;
import static eft.http.JSONResponses.INCORRECT_POLL_NAME_LENGTH;
import static eft.http.JSONResponses.INCORRECT_POLL_OPTION_LENGTH;
import static eft.http.JSONResponses.MISSING_DESCRIPTION;
import static eft.http.JSONResponses.MISSING_MAXNUMBEROFOPTIONS;
import static eft.http.JSONResponses.MISSING_MINNUMBEROFOPTIONS;
import static eft.http.JSONResponses.MISSING_NAME;
import static eft.http.JSONResponses.MISSING_OPTIONSAREBINARY;
