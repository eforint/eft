...
final class JSONData {
    ...
    static JSONObject accountBalance(Account account) {
        ...
        if (account == null) {
            ...
            json.put("effectiveBalanceEFT", "0");
            ...
            synchronized (account) { // to make sure balance and unconfirmedBalance are consistent
                ...
                json.put("effectiveBalanceEFT", account.getEffectiveBalanceEFT());
    ...
    static JSONObject transaction(Transaction transaction) {
        ...
        json.put("confirmations", Eft.getBlockchain().getLastBlock().getHeight() - transaction.getHeight());
