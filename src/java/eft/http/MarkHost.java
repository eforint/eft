...
import static eft.http.JSONResponses.INCORRECT_DATE;
import static eft.http.JSONResponses.INCORRECT_HOST;
import static eft.http.JSONResponses.INCORRECT_WEIGHT;
import static eft.http.JSONResponses.MISSING_DATE;
import static eft.http.JSONResponses.MISSING_HOST;
import static eft.http.JSONResponses.MISSING_SECRET_PHRASE;
import static eft.http.JSONResponses.MISSING_WEIGHT;
...
public final class MarkHost extends APIServlet.APIRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req) {
        ...
        try {
            ...
            if (weight <= 0 || weight > Constants.MAX_BALANCE_EFT) {
