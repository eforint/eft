...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Block> blockIterator = Eft.getBlockchain().getBlocks(account, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Eft.getBlockchain().getTransactions(account, (byte) -1, (byte) -1, 0)) {
