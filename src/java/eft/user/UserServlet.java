...
import static eft.user.JSONResponses.DENY_ACCESS;
import static eft.user.JSONResponses.INCORRECT_REQUEST;
import static eft.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws EftException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Eft.getBooleanProperty("eft.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|EftException e) {
