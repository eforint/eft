...
/**
 * Handle logging for the Eft node server
 */
public final class Logger {
     ...
     * The eft/conf/logging-default.properties and eft/conf/logging.properties configuration
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "eft.util.EftLogManager");
        if (!(LogManager.getLogManager() instanceof EftLogManager)) {
        ...
        log = org.slf4j.LoggerFactory.getLogger(eft.Eft.class);
        enableStackTraces = Eft.getBooleanProperty("eft.enableStackTraces");
        enableLogTraceback = Eft.getBooleanProperty("eft.enableLogTraceback");
    ...
    public static void shutdown() {
        if (LogManager.getLogManager() instanceof EftLogManager) {
            ((EftLogManager) LogManager.getLogManager()).eftShutdown();
        }
    }
